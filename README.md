...
<h2 align="center">AiRenoOS Backend Engine</h2>

<p align="center">
  <b>A backend engine built with NestJS, TypeORM, PostgreSQL, and Socket.IO</b><br/>
  <sub>Provides authentication (JWT + RefreshToken), realtime updates, and API documentation via SwaggerUI.</sub>
</p>
...
# Application
PORT=5000
JWT_SECRET=DC64DF3C11D314B7D9551E5CF52DC
JWT_ISSUER=http://localhost:5000
JWT_AUDIENCE=http://localhost:5000
JWT_EXPIRES_IN=1 # minutes
